...
| [機械学習から始めるプログラミング入門](https://k2works.github.io/getting-started-machine-learning/) | 機械学習を軸にした言語入門 | 機械学習の題材をテストファーストで実装しながら、データ前処理、CI/CD、評価指標、モデル選択、API 設計まで多言語で学べます。 |
